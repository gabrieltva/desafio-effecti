...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de linguagem a seguir contêm as mensagens de erro padrão
    | usadas pela classe validadora. Algumas dessas regras têm várias
    | versões, como as regras de tamanho. Fique à vontade para ajustar
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O :attribute informado apareceu em uma violação de dados. Escolha outro :attribute.',
    ],
    ...
    'relatable' => 'O campo :attribute pode não estar associado a esse recurso.',
    ...
    | atributos utilizando a convenção "atributo.regra" para nomear as linhas.
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir são usadas para trocar o espaço reservado do atributo
    | por algo mais amigável ao leitor, como "Endereço de E-Mail" em vez
    | de "email". Isso simplesmente nos ajuda a tornar a mensagem um pouco
    | mais clara.
    |
    */
